    ...
    case WM_PAINT:
        {
			...
			TextOut(hdc, 100, 100, L"Hello, World!", strlen("Hello, World!"));
			TextOut(hdc, 200, 100, L"Hello, World!", strlen("Hello, World!"));
			TextOut(hdc, 100, 200, L"Hello, World!", strlen("Hello, World!"));
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
