    ...
    case WM_PAINT:
        {
			...
			myFont = CreateFont(30, 0, 0, 0, 0, 0, 0, 0, HANGEUL_CHARSET, 0, 0, 0, 0, L"궁서");
			oldFont = (HFONT)SelectObject(hdc, myFont);
			//이름
			TCHAR szMsgName[] = L"박  규  진";
			...
			//연락처
			myFont = CreateFont(18, 0, 0, 0, 0, 0, 0, 0, HANGEUL_CHARSET, 0, 0, 0, 0, L"궁서");
			TCHAR szMsgcall[] = L"연락처 : dktmzdf@gmail.com";
			SetTextColor(hdc, RGB(0, 255, 0));
			SetBkMode(hdc, TRANSPARENT);
			...
			//홈페이지
			myFont = CreateFont(18, 0, 0, 0, 0, 0, 0, 0, HANGEUL_CHARSET, 0, 0, 0, 0, L"궁서");
			TCHAR szMsgPage[] = L"홈페이지: dktmzdf.github.io/C_study2017";
			SetTextColor(hdc, RGB(0, 255, 0));
			SetBkMode(hdc, TRANSPARENT);
			TextOut(hdc, 120, 230, szMsgPage, wcslen(szMsgPage));
			SelectObject(hdc, oldFont);
			//주소
			myFont = CreateFont(180, 0, 0, 0, 0, 0, 0, 0, HANGEUL_CHARSET, 0, 0, 0, 0, L"궁서");
			TCHAR szMsgHome[] = L"주소: 인천광역시 연수구 청학동";
			SetTextColor(hdc, RGB(0, 255, 0));
			SetBkMode(hdc, TRANSPARENT);
