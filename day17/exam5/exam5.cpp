...
DWORD WINAPI myThreadFunc(LPVOID pParam) 
{
	...
	while(1) {
		...
		//grp.Clear(Color(200, 200, 200));
		SolidBrush brush(Color(255, 0, 0));
		//grp.FillRectangle(&brush,100 * (i * 10),100,150,20);
		Sleep(10);
		plusEngine::printf(&grp, rand() % 1000, rand() % 1000, L"%d", Count);
		Count++;
    ...
    case WM_PAINT:
        {
			...
			Graphics grp(hdc);
			plusEngine::printf(&grp, 100, 100, L"start");
