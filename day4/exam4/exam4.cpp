    ...
    case WM_PAINT:
        {
			...
			FontFamily fontfam(L"굴림");
			Font fontGulim(&fontfam,40,FontStyleRegular,UnitPixel);

			SolidBrush brushBlue(Color(0,0,255));
			SolidBrush brushBlack(Color(0, 0, 0));

			graphic.DrawString(L"안녕하세요", -1, &fontGulim, PointF(100, 100), &brushBlue);
			graphic.DrawString(L"안녕하세요", -1, &fontGulim, PointF(100, 100+50), &brushBlack);
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
