    ...
    case WM_COMMAND:
        {
			...
			case ID_TOOL_PIXEL:
			{
				...
				SetPixel(hdc,xPos,yPos, RGB(RValue, GValue, BValue));
			...
			case ID_TOOL_LINE:
			{
				...
				HDC hdc = GetDC(hWnd);
				HPEN myPen, oldPen;
				myPen = CreatePen(PS_SOLID, 1, RGB(RValue, GValue, BValue));
			...
			case ID_TOOL_CIRCLE: 
			{
				...
				Ellipse(hdc, xPos, yPos, xSize, ySize);
