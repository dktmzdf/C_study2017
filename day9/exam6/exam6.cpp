    ...
    case WM_COMMAND:
        {
			...
			case IDM_RUN:
			{
				...
				int i = 0;
				int nCount=0;
				nCount = mywin32_engine::util::Buffer2DoubleArray(szBuf, nGrowth);
				...
				mywin32_engine::SetControlValueDouble(hWnd, 3003, extra_growth(nGrowth,lfSum/nCount,nCount));
				
				
				/*
				int n_szInputBuf_Size = wcslen(szBuf);
				int nTempIndex=0;
				int nSum=0;
