...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		CreateWindow(L"static", L"키를 입력하세요", WS_CHILD | WS_VISIBLE,
		...
		CreateWindow(L"static", L"몸무게를 입력하세요", WS_CHILD | WS_VISIBLE,
