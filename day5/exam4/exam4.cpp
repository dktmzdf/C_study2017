    ...
    case WM_PAINT:
        {
            ...
            // TODO: 여기에 hdc를 사용하는 그리기 코드를 추가합니다.
			{
				...
				TCHAR szBuf[256];
				swprintf_s(szBuf, 256, L"%c , %c , %c , %d", ch, 'A' + 1, ch + 2, '0' +1);
				TextOut(hdc,10,10,szBuf,wcslen(szBuf));

				swprintf_s(szBuf, 256, L"char size : %d short size : %d int size : %d long size : %d", sizeof(char), sizeof(short), sizeof(int), sizeof(long));
				TextOut(hdc, 100, 100, szBuf, wcslen(szBuf));
				swprintf_s(szBuf, 256, L"float size : %d double size : %d long double size : %d", sizeof(float), sizeof(double), sizeof(long double));
