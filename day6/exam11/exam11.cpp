...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		//CreateWindow(L"static", L"을 입력하세요", WS_CHILD | WS_VISIBLE,
		//	140, 0, 150, 25, hWnd, (HMENU)-1, hInst, NULL);
		mywin32_engine::makeMiniEdit(hWnd, 10, 10, 3001);
		mywin32_engine::makeMiniEdit(hWnd, 120, 10, 3002);
		mywin32_engine::makeMiniEdit(hWnd, 230, 10, 3003);
		mywin32_engine::makeMiniEdit(hWnd, 340, 10, 3004);//합계
		mywin32_engine::makeMiniEdit(hWnd, 450, 10, 3005);//평균
		mywin32_engine::makeMiniButton(hWnd,10,60,4001,L"OK");
    ...
    case WM_COMMAND:
        {
			...
			case 4001:
			{
				...
				mywin32_engine::SetControlValueInt(hWnd, 3005, nMin);
				ReleaseDC(hWnd, hdc);
			}
			break;
            case IDM_ABOUT:
